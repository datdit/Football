    ...
    'columns' => array(
        ...
        array(
            ...
            'value' => '(!empty($data->pic))?
                CHtml::image("./images/ground/" .   $data->pic,"",array("style" => "width:50px;"))
                :"no image"',
        ),
        'GroundName',
        'Price',
        array(
            ...
            'buttons' => array(
                'edit' => array(
                    ...
                    'url' => 'Yii::app()->createUrl("Ground/GroundForm", array("id" => $data->id))'
                ),
                'delete' => array(
                    'label' => 'Delete',
                    //'visible' => '($data->id < 2 )?false:true',
                    'imageUrl' => Yii::app()->theme->baseUrl . "/css/gridViewStyle/icon/del.jpg",
                    'url' => 'Yii::app()->createUrl("Ground/Delete", array("id" => $data->id))',
